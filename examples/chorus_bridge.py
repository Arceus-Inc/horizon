"""The composition root: adapt chorus's concrete classes to horizon's ``dream.contracts`` ports.
...
class ChorusIntakePort:
    ...
    def submit(
        ...
        *,
        ...
        existing = self._chorus._ledger.tasks.find_by_origin(
            OriginKind.HORIZON_INTAKE, fingerprint
        )
